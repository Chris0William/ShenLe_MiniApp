      ...
      return common_vendor.e({
        ...
        i: common_vendor.f(regionList.value, (r, k0, i0) => {
          return common_vendor.e({
            ...
            e: common_vendor.t(r.stats.propertyCount),
            f: getRate(r.stats.rentedCount, r.stats.propertyCount) + "%",
            g: common_vendor.t(getRate(r.stats.rentedCount, r.stats.propertyCount))
          } : {}, {
            h: r.id,
            i: common_vendor.o(($event) => drillRegion(r), r.id)
          });
        })
      }) : {}, {
        j: level.value === 2
          ...
          return common_vendor.e({
            ...
            c: common_vendor.f(cd.buildings, (b, k1, i1) => {
              return {
                ...
                d: common_vendor.t(b.propertyCount),
                e: common_vendor.t(b.totalFloors ?? "-"),
                f: b.id,
                g: common_vendor.o(($event) => drillBuilding(b, cd.community.name), b.id)
              };
            })
          }, {
            d: cd.community.id
