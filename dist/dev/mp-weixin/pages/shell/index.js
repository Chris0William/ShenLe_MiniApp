...
if (!Math) {
  (UserHome + UserMap + UserMine + AdminMap + AdminDashboard + AdminPropertyList + AdminSalesControl + AdminMine + _easycom_sl_custom_tabbar)();
}
const UserHome = () => "../user/home/index2.js";
const UserMap = () => "../user/map/index2.js";
const UserMine = () => "../user/mine/index2.js";
const AdminMap = () => "../user/map/index2.js";
...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const adminTabKeys = ["admin-map", "admin-property-list", "admin-dashboard", "admin-sales-control", "admin-mine"];
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        g: visited.has("admin-map")
      }, visited.has("admin-map") ? {
        h: common_vendor.unref(appStore).currentTab === "admin-map"
      } : {}, {
        i: visited.has("admin-dashboard")
      }, visited.has("admin-dashboard") ? {
        j: common_vendor.unref(appStore).currentTab === "admin-dashboard"
      } : {}, {
        k: visited.has("admin-property-list")
      }, visited.has("admin-property-list") ? {
        l: common_vendor.unref(appStore).currentTab === "admin-property-list"
      } : {}, {
        m: visited.has("admin-sales-control")
      }, visited.has("admin-sales-control") ? {
        n: common_vendor.unref(appStore).currentTab === "admin-sales-control"
      } : {}, {
        o: visited.has("admin-mine")
      }, visited.has("admin-mine") ? {
        p: common_vendor.unref(appStore).currentTab === "admin-mine"
      } : {}, {
        ...
        s: common_vendor.unref(userStore).showLoginPopup
      }, common_vendor.unref(userStore).showLoginPopup ? common_vendor.e({
        t: common_vendor.unref(userStore).popupStep === "login"
      }, common_vendor.unref(userStore).popupStep === "login" ? {
        v: common_vendor.t(popupLoading.value ? "登录中..." : "微信一键登录"),
        w: popupLoading.value,
        x: common_vendor.o(onPopupWxLogin)
      } : {}, {
        y: common_vendor.unref(userStore).popupStep === "profile"
      }, common_vendor.unref(userStore).popupStep === "profile" ? common_vendor.e({
        z: profileAvatarTemp.value
      }, profileAvatarTemp.value ? {
        A: profileAvatarTemp.value
      } : {}, {
        B: common_vendor.o(onChooseAvatar),
        C: profileNickName.value,
        D: common_vendor.o(($event) => profileNickName.value = $event.detail.value),
        E: common_vendor.t(popupLoading.value ? "提交中..." : "完成注册"),
        F: popupLoading.value,
        G: common_vendor.o(onProfileSubmit)
      }) : {}) : {});
    };
  }
});
