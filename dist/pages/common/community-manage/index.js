...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    function openAdd() {
      isEdit.value = false;
      form.value = { id: "", name: "", regionId: "", address: "", orderNo: 0 };
      showForm.value = true;
    }
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        x: common_vendor.o(($event) => showForm.value = false),
        y: common_vendor.o(onSubmit),
        z: common_vendor.o(() => {
        }),
        A: common_vendor.o(($event) => showForm.value = false)
      } : {}, {
        B: showRegionPicker.value
      }, showRegionPicker.value ? {
        C: common_vendor.f(flattenRegions(regionTree.value), (r, k0, i0) => {
          return {
            a: common_vendor.t(r.name),
            b: r.id,
        ...
        E: common_vendor.o(($event) => showRegionPicker.value = false)
      } : {});
    };
  }
});
