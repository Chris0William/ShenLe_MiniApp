        ...
        success: async (res) => {
          for (const path of res.tempFilePaths) {
            try {
              ...
              form.imageUrls.push(api_file.getPreviewUrl(file.id));
    ...
    async function onSubmit() {
      ...
      try {
        const data = {
          ...
          totalFloor: Number(form.totalFloor) || 0,
          roomNumber: form.roomNumber,
          area: Number(form.area) || 0,
          bedrooms: form.bedrooms,
          livingRooms: form.livingRooms,
          bathrooms: form.bathrooms,
          orientation: form.orientationIdx >= 0 ? utils_constants.ORIENTATIONS[form.orientationIdx] : "",
          decoration: form.decorationIdx >= 0 ? utils_constants.DECORATIONS[form.decorationIdx] : "",
          rentalType: form.rentalTypeIdx >= 0 ? utils_constants.RENTAL_TYPES[form.rentalTypeIdx] : "",
          monthlyRent: Number(form.monthlyRent) || 0,
          deposit: Number(form.deposit) || 0,
          depositMonths: form.depositRuleIdx >= 0 ? utils_constants.DEPOSIT_RULES[form.depositRuleIdx].deposit : void 0,
          paymentMonths: form.depositRuleIdx >= 0 ? utils_constants.DEPOSIT_RULES[form.depositRuleIdx].payment : void 0,
          description: form.description,
          contactName: form.contactName,
          contactPhone: form.contactPhone,
          status: 0,
          coverImageId: form.coverImageId || void 0,
          tagIds: form.selectedTagIds,
          facilityTagIds: form.selectedFacilityIds,
          imageIds: form.imageIds
        };
        if (isEdit.value) {
          await api_property.updateProperty({ ...data, id: editId.value });
    ...
    common_vendor.onLoad(async (options) => {
      ...
      if (options == null ? void 0 : options.id) {
        ...
        try {
          ...
          form.totalFloor = String(detail.totalFloor);
          ...
          form.monthlyRent = String(detail.monthlyRent);
          ...
          form.imageUrls = ((_d = detail.images) == null ? void 0 : _d.map((i) => api_file.getPreviewUrl(i.id))) || [];
